...
public class MorphyToolbar extends RelativeLayout {
    ...
    private void inflate() {
        final View view = inflate(getContext(), R.layout.view_morphy_toolbar, this);
        innerLayout = (LinearLayout) view.findViewById(R.id.mt_layout_toolbar);
        imgPicture = (ImageView) innerLayout.findViewById(R.id.mt_img_picture);

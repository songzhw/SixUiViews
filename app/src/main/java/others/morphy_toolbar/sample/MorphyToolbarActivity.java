package others.morphy_toolbar.sample;
...
import others.morphy_toolbar.MorphyToolbar;


public class MorphyToolbarActivity extends AppCompatActivity {

    MorphyToolbar morphyToolbar;
    int primary2 = 0xfffbc757;
    int primaryDark2 = 0xffe6b449;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_morphy_test);
        ...
        morphyToolbar = MorphyToolbar.builder(this, toolbar)
                                     ...
                                     .withPicture(R.drawable.forest2)

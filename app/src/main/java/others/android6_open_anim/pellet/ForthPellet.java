package others.android6_open_anim.pellet;
...
//        mEndAnimator.setRepeatCount(2);
    ...
    protected ValueAnimator createRotateAnim() {
        ...
        final int[] colors = new int[]{A6Colors.TRANSPARENT, A6Colors.TRANSPARENT, A6Colors.BLUE};
    ...
    protected ValueAnimator createColorfulAnim() {
        ...
        final int[] colors1 = new int[]{A6Colors.YELLOW, A6Colors.YELLOW, A6Colors.GREEN, A6Colors.GREEN};
        final int[] colors2 = new int[]{A6Colors.YELLOW, A6Colors.YELLOW, A6Colors.RED, A6Colors.RED, A6Colors.BLUE, A6Colors.BLUE};
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (mCurValue <= 100) {
                    ...
                    colors1[0] = A6Colors.BLUE;
                    colors1[1] = A6Colors.BLUE;
                    colors1[2] = A6Colors.YELLOW;
                    colors1[3] = A6Colors.YELLOW;
                    positions1[0] = 0;
        ...
        animator.addListener(new
                                     AnimatorListenerAdapter() {
                                         ...
                                         public void onAnimationStart(Animator animation) {
                                             ...
                                             positions2[1] = 0f;
                                             positions2[0] = 0f;
                                             colors1[0] = A6Colors.YELLOW;
                                             colors1[1] = A6Colors.YELLOW;
                                             colors1[2] = A6Colors.GREEN;
                                             colors1[3] = A6Colors.GREEN;

package others.swipe_num_picker;
	...
	private void initAttributes(Context context, AttributeSet attributeSet) {
		...
		if (attrs != null) {
			try {
				...
				mArrowColor = attrs.getColor(R.styleable.SwipeNumberPicker_snp_arrowColor, context.getResources().getColor(R.color.snp_arrows));
				mBackgroundColor = attrs.getColor(R.styleable.SwipeNumberPicker_snp_backgroundColor, context.getResources().getColor(R.color.snp_background));
				mNumColor = attrs.getColor(R.styleable.SwipeNumberPicker_snp_numberColor, context.getResources().getColor(R.color.snap_text));
		...
		mCornerRadius = context.getResources().getDimension(R.dimen.snp_radius);
		mStrokeWidth = context.getResources().getDimension(R.dimen.snap_stroke_width);

package others.circle_reveal.demo;
...
public class CircleRevealDemo extends AppCompatActivity implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_circle_reveal_one);

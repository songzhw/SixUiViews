package others.drag_scale_circle_view.demo;
...
import others.drag_scale_circle_view.DragScaleCircleView;

public class DragScaleCircleViewTest extends AppCompatActivity {
...
//    DiscreteSeekBar guideLineSizeSeek;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dscv_test);
        ...
        croppedImage.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                PopupMenu popupMenu = new PopupMenu(DragScaleCircleViewTest.this, croppedImage);

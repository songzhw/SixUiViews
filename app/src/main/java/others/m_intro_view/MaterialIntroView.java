...
import others.m_intro_view.animation.AnimationFactory;
import others.m_intro_view.animation.AnimationListener;
import others.m_intro_view.animation.MaterialIntroListener;
import others.m_intro_view.shape.Circle;
import others.m_intro_view.shape.Focus;
import others.m_intro_view.shape.FocusGravity;
import others.m_intro_view.target.Target;
import others.m_intro_view.target.ViewTarget;
import others.m_intro_view.util.PreferencesManager;
...
public class MaterialIntroView extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        colorTextViewInfo = DEFAULT_COLOR_TEXTVIEW_INFO;
        focusType = Focus.ALL;
        ...
        View layoutInfo = LayoutInflater.from(getContext()).inflate(R.layout.view_m_intro_card, null);
        ...
        dotView = LayoutInflater.from(getContext()).inflate(R.layout.view_single_iv, null);
    ...
    private void setDotViewLayout() {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                dotViewLayoutParams.height = dpToPx(DEFAULT_DOT_SIZE);
                dotViewLayoutParams.width = dpToPx(DEFAULT_DOT_SIZE);
